                  ...
                  <div style={{ maxWidth: '700px', margin: '0px auto', fontSize: '14px' }}>
                      ...
                      <tbody>
                        <tr>
                          <td style={{ verticalAlign: 'top' }}>
                            <img src="/resources/images/logo.png" alt="TripValet Incentives" style={{ height: '40px' }} />
                          </td>
                    ...
                    >
                      <p>
                        ...
                        <br />
                        Powered by TripValet Incentives
                      </p>
                    </div>
                  </div>
                </div>
                        ...
                        <tbody>
                          <tr>
                            <td>
                              ...
                              <p>Seems like you forgot your password for TripValet Incentives. If this is true, click below to reset your password.</p>
                          ...
                          <tr>
                            <td>
                              ...
                              <p style={{ textAlign: 'center' }}>
                                ...
                                <a href="javascript: void(0);" style={{ color: '#01a8fe', textDecoration: 'underline' }}>
