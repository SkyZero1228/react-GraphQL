...
import { reduce, some, pullAllBy, includes } from 'lodash';
...
class MenuLeft extends React.Component {
  ...
  render() {
    ...
    let logoContainer = cn('menuLeft__logoContainer', {
      menuLeft__logoContainer__light: theme === 'light',
      'menuLeft__logoContainer--collapsed': params.collapsed,
    });
    let menuLeftLogo = cn('menuLeft__logo', { menuLeft__logo__light: theme === 'light' });
