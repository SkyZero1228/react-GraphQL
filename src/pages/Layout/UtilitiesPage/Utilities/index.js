        ...
        <section className="card">
          <div className="card-header">
            <div className="utils__title">
              ...
              <a href="https://getbootstrap.com/docs/4.1/utilities/borders/" target="_blank" rel="noopener noreferrer" className="btn btn-sm btn-primary ml-4">
          ...
          <div className="card-body">
            <div className="alert alert-warning" role="alert">
              <p className="mb-0">
                <strong>Attention!</strong> This is only a part of all Bootstrap Utilites. Follow next link to get information about all of them:{' '}
                <a href="https://getbootstrap.com/docs/4.1/utilities/borders/" target="_blank" rel="noopener noreferrer" className="mr-3">
                  ...
                  <table className="table table-hover">
                    ...
                    <tbody>
                      <tr>
                        ...
                        <td>
                          <a href="javascript: void(0)" target="_blank" rel="noopener noreferrer" className="utils__link--underlined">
                            Underlined Link
                          </a>
                        </td>
                      </tr>
                      <tr>
                        ...
                        <td>
                          <a href="javascript: void(0)" target="_blank" rel="noopener noreferrer" className="utils__link--blue">
                            Blue Link
                          </a>
                        </td>
                      </tr>
                      <tr>
                        ...
                        <td>
                          <a href="javascript: void(0)" target="_blank" rel="noopener noreferrer" className="utils__link--underlined utils__link--blue">
              ...
              <div className="col-lg-6">
                <div className="mb-5">
                  ...
                  <div className="utils__example">
                    ...
                    <p className="text-justify">Justified text: Lorem Ipsum is simply dummy text of the printing and typesetting industry. Lorem Ipsum has been the industry's standard dummy text ever since the 1500s, when an unknown printer took a galley of type and scrambled it to make a type specimen book</p>
                  </div>
                </div>
              </div>
            </div>
